...
<body>
    <form id="form1" runat="server">
      ...
      <asp:SqlDataSource id="ProductsDataSource"
        SelectCommand="SELECT ProductID, Name, ProductNumber, ListPrice FROM SalesLT.Product WHERE (ListPrice &lt;&gt; 0)"
        UpdateCommand="UPDATE SalesLT.Product SET [ListPrice] = @ListPrice 
